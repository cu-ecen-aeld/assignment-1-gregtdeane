...
void test_validate_my_username()
{
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(hardcoded_username, file_username, "Hardcoded username and username from file do not match.");

    free(file_username); // Important: Free the allocated memory
}
